                ...
                <div class="card">
                  <div class="card-body pt-3">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered">
                      ...
                      <li class="nav-item">
                        <button class="nav-link " data-bs-toggle="tab" data-bs-target="#profile-edit">Modifier produit</button>
                      </li>
                      ...
                      <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                        ...
                        <form method="POST" action="/products/{{$product->id}}">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <input name="category" type="text" value="{{$product->category}}" class="form-control" id="category">
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <input name="price" type="number" step="0.01" value="{{$product->price}}" class="form-control" id="price">
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <input name="current_stock" type="number" value="{{$product->current_stock}}" class="form-control" id="current_stock">
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                              <input name="minimum_stock" type="number" value="{{$product->minimum_stock}}" class="form-control" id="minimum_stock">
                            </div>
                          </div>
